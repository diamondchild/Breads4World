<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FoodRequest.aspx.vb" Inherits="FoodRequest" %>
...
<head>
<title>Bread4World/FoodRequest</title>
...
<body>
	...
	<div class="banner">
		...
		<div class="wthree-heading">
			<h2>&nbsp;FOOD items REQUEST</h2><br /><br />
                                 ...
                                 style="width: 29%; margin-right: auto; margin-left: auto"><tr>
                                     <td style="color: #FFFFFF" class="style1">
                                         &nbsp;</td><td>
                                            ...
                                            </td></tr><tr><td style="color: #FFFFFF"  class="style1">Total Food Items Balance(USD):</td><td>
											<input id="txtFoodItemBalance" runat="server"  type="text" style="width: 100%" 
                                                disabled="disabled" />
