<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FoodStuffRequest.aspx.vb" Inherits="FoodStuffRequest" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Bread4World/FoodStuffRequest</title>
...
<body>
    ...
    <div style="width: 900px; margin-right: auto; margin-left: auto; text-align: center;">
        <div style="text-align: center; font-weight: 700; background-color: #99FF99; color: #000000; font-size: medium; font-family: 'Arial Rounded MT Bold';">
            Qualified Members For Food Items</div>
                  ...
                  <tr style="background-color: #339933; color: #FFFFFF; font-weight: bold; text-align: center; font-size: 15px;">
                       ...
                       <td class="reapeatercell_header">
                         CURRENT STAGE</td>
                           ...
                           <td class="reapeatercell_header">
                          TOTAL FOOD ITEM BALANCE
                          </td>
                           <td class="reapeatercell_header">
                          REQUESTED FOOD ITEM AMOUNT
                          </td>
              ...
              <tr class="reapeatercell" style="background-color:#f2F9FF; width: 100%; text-align: center;">
                  <tr class="reapeatercell" style="background-color:#DFDFFF; text-align: center; font-size: 13px;">
                      <asp:HiddenField ID="systemHiddenID" runat="server" Value='<%# Eval("REG_ID") %>' Visible="false" />
                       <asp:HiddenField ID="requestedAmount" runat="server" Value='<%# Eval("REQUESTED_FOOD_AMOUNT") %>' Visible="false" />
                      ...
                      <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "CURRENT_STAGE")%>
                      </td>
                      <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "TOTAL_FOODSTUFF_EARN_U")%>
                      </td>

                      <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "TOTAL_FOODSTUFF_BALANCE_U")%>
                      </td>

                       <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "REQUESTED_FOOD_AMOUNT")%>
                      </td>
                     <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "REQUEST_FOOD_TRANSFER")%>
                      </td>
                     <td > <asp:Linkbutton ID="btnViewDetails" runat="server" Text="Collected?"  commandname = "viewDetails" OnClientClick ="return confirm('Have this person collected his/her Food ITEMS? if Yes, click OK')"/> </td>
              </tr>
                  <tr>
                      <td  colspan="4">
                          &nbsp;</td>
