...
<head>
<title>Bread4World/Transfer</title>
              ...
              <tr class="reapeatercell" style="background-color:#f2F9FF; width: 100%; text-align: center;">
                  <tr class="reapeatercell" style="background-color:#DFDFFF; text-align: center; font-size: 13px;">
                      <asp:HiddenField ID="systemHiddenID" runat="server" Value='<%# Eval("REG_ID") %>' Visible="false" />
                       <asp:HiddenField ID="requestedAmount" runat="server" Value='<%# Eval("REQUESTED_AMOUNT") %>' Visible="false" />
                      ...
                      <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "TOTAL_BONUS_EARN_U")%>
                      </td>

                      <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "TOTAL_EWALLET_BALANCE_U")%>
                      </td>

                       <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "REQUESTED_AMOUNT")%>
                      </td>
                     <td class="reapeatercell">
                          <%# DataBinder.Eval(Container.DataItem, "REQUEST_TRANSFER")%>
                      </td>
                     <td > <asp:Linkbutton ID="btnViewDetails" runat="server" Text="Bank Details"  commandname = "viewDetails" OnClientClick ="return confirm('Do you want to proceed to paid this person? if Yes, click OK')"/> </td>
              </tr>
                  <tr>
                      <td  colspan="4">
                          &nbsp;</td>
